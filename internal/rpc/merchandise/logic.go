...
func (m *Merchandise) AddMerchandiseStyle(ctx context.Context, req *merchandise.AddMerchandiseStyleReq, resp *merchandise.AddMerchandiseStyleResp) error {
	uid := ctx.Value("user_id").(string)
	id := tools.CreateID()
...
func (m *Merchandise) RemoveMerchandiseStyle(ctx context.Context, req *merchandise.RemoveMerchandiseStyleReq, resp *merchandise.RemoveMerchandiseStyleResp) error {
	uid := ctx.Value("user_id").(string)
...
func (m *Merchandise) UpdateMerchandiseStyle(ctx context.Context, req *merchandise.UpdateMerchandiseStyleReq, resp *merchandise.UpdateMerchandiseStyleResp) error {
	uid := ctx.Value("user_id").(string)
...
func (m *Merchandise) GetMerchandiseStyleList(ctx context.Context, req *merchandise.GetMerchandiseStyleListReq, resp *merchandise.GetMerchandiseStyleListResp) error {
	must := []types.Query{
		{
			MatchPhrase: map[string]types.MatchPhraseQuery{
...
func (m *Merchandise) GetMerchandiseStyleDetails(ctx context.Context, req *merchandise.GetMerchandiseStyleDetailsReq, resp *merchandise.GetMerchandiseStyleDetailsResp) error {
